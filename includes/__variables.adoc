...
:command-warning: image:images/command-warning.png[Command association warning.]
:edit-menu-partial: image:images/edit-menu-2.png[Partial edit menu.]
...
:insert-codebox: image:images/insert-codebox.png[Insert codebox menu.]
:edit-codebox: image:images/edit-codebox.png[Edit codebox menu.]
:attach-file: image:images/attach-file.png[File attachment menu.]
:insert-link: image:images/insert-link.png[Insert link menu.]
:edit-link: image:images/edit-link.png[Edit link menu.]
:inv-nodes: image:images/inv-nodes.png[Involved nodes menu.]
:insert-anchor: image:images/insert-anchor.png[Insert anchor menu.]
:edit-anchor: image:images/edit-anchor.png[Edit anchor menu.]

// Settings Images
:text-code-pref: image:images/pref01.png[Text and Code.]
:text-pref: image:images/pref02.png[Text.]
:rich-text-pref: image:images/pref03.png[Rich Text.]
:plain-text-code-pref: image:images/pref04.png[Plain Text and Code.]
:tree1-pref: image:images/pref05.png[Tree 1.]
:tree2-pref: image:images/pref06.png[Tree 2.]
:fonts-pref: image:images/pref07.png[Fonts.]
:links-pref: image:images/pref08.png[Links.]
:toolbar-pref: image:images/pref09.png[Toolbar.]
:keyboard-pref: image:images/pref10.png[Keyboard Shortcuts.]
:misc-pref: image:images/pref11.png[Miscellaneous.]
...
:select-language-menu: image:images/select-language-menu.png[Select language menu.]
:edit-command: image:images/edit-command.png[Edit command demonstration.]
...
:select-element-menu: image:images/select-element-menu.png[Select element menu.]
...
:edit-shortcut-menu: image:images/edit-shortcut-menu.png[Edit shortcut menu.]
