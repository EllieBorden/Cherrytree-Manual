...
. If this is your first time saving the current document, you will be prompted to select a save type, as shown in <<figure-3.10>>. If you are unsure which type to select, please visit the link:#_save_type[save type section] for more details. +
+
[[figure-3.10]]
.Figure 3.10
{save-type}
